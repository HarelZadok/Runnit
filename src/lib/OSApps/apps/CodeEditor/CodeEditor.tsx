...
export default class CodeEditor extends OSApp {
	...
	body() {
		return <div className="w-full h-full">
			<Editor width="100%" height="100%" defaultLanguage="typescript" onMount={this.handleEditorDidMount} />
		</div>;
	}
	...
	private handleEditorDidMount = (editor: editor.IStandaloneCodeEditor, monaco: Monaco) => {
